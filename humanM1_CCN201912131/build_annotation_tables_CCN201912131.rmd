...
updated_nomenclature <- read.csv("nomenclature_table_CCN201912131.csv")
```
...
write.csv(updated_nomenclature,"nomenclature_table_CCN201912131_withExtra.csv",row.names = FALSE)
```
...
pdf("updated_dendrogram_CCN201912131.pdf",height=8,width=15)
...
save(updated_dendrogram, file="updated_dendrogram_CCN201912131.RData")
```
...
out <- file("dend_CCN201912131.json", open = "w")
...
```{r} 
fwrite(mapping,"cell_to_cell_set_assignments_CCN201912131.csv")
```    
